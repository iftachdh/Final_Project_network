...
def generate_image(times, sizes, filename, output_folder):
    ...
    ax.set_title('Packet Timing and Size Representation')  # Set title for the histogram.
...
def main():
    ...
    if flag == '1':
        output_folder = 'FlowPicsFilter'
    else:
        output_folder = 'FlowPics'
    if not os.path.exists(output_folder):
        os.makedirs(output_folder)

    folder_path = 'all_records'
